...
\todo{hablar mas sobre comparacion con otros trabajos}

\todo{agregar seccion de limitaciones}
...
\todo{expandir en recomendaciones sobre trabajos futuros}

\todo{"para continuar esta linea de investigacion, recomiendo tal y tal" recomendaciones}
...
\begin{itemize}
    ...
    \item Análisis de datos provenientes de otros proveedores, haciendo uso de un conjunto sensores diferentes. \todo[inline]{proveedores... de que}
\end{itemize}
