...
\subsection{Visualización en Jupyter Notebook, parte 1}
\begin{figure}[ht!]
    \centering
...
\newpage
\subsection{Visualización en Jupyter Notebook, parte 2}
\begin{figure}[ht!]
    \centering
...
\newpage
\subsection{Ejemplo de configuración de modelo, DataModule y Trainer}
\begin{figure}[ht!]
    \centering
...
\newpage
\subsection{Visualización de resultados de predicción para una imagen de entrada}
\begin{figure}[ht!]
    \centering
