...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{osm-area-estudio.png}
    ...
    \label{fig:4}
\end{figure}
\todo{mejorar mapa con escala, coord UTM, norte en qgis}
...
\todo[inline]{add figure of what the end result might look like}
