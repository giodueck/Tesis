...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\textwidth]{img/osm-area-estudio.png}
    \caption{Parque Nacional Médanos del Chaco (verde) y Abanico Aluvial del Pilcomayo (azul). Elaboración propia con el mapa de OpenStreetMap. \cite{OpenStreetMap}}
    \label{fig:4}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{img/mapa-humedales.png}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{|l|l|p{5cm}|l|l|}
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T20KNC.jpg}} \\
        \hline
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T20KPA.jpg}} \\
        \hline
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T20KQA.jpg}} \\
        \hline
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T20JQS.jpg}} \\
        \hline
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T21JTL.jpg}} \\
        \hline
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T21JTM.jpg}} \\
        \hline
        ...
        Prueba &
        \raisebox{-1.2cm}{\includegraphics[width=64px,trim=-10px -10px -10px -10px]{img/T21JUL.jpg}} \\
        \hline
