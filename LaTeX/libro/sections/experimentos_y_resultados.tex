...
Las máscaras utilizadas para el entrenamiento, es decir, aquellas correspoindientes a las teselas T20KNA, T20KNB y T20KPC, se encuentran disponibles en el repositorio de Torchbearer \cite{torchbearer}.
...
\begin{figure}[h!]
    ...
    \caption{Predicciones en el área de trabajo del análisis de recursos hídricos en Marical Estigarribia.}
    \label{fig:mariscal}
\end{figure}
