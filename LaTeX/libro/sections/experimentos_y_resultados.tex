...
\begin{table}[ht!]
    ...
    \begin{tabular}{ |l|r|r|p{8cm}| }
        ...
        Tamaño de lote (batch) & 3 & 12 & Cantidad de imágenes cargadas y procesadas en cada paso de entrenamiento. Subdivide a cada época. \\
        \hline
    \end{tabular}
...
Estas celdas de $128\times128$ o $192\times192$ píxeles se combinan para formar un mosaico de predicciones. Para mitigar los artefactos que pueden surgir en los bordes de estas celdas, estas se solapan ligeramente. Se toman pasos de 100 y 112 píxeles para predicciones de 128 y 172 y 180 píxeles para predicciones de 192, se combinan mosaicos de cada tamaño de paso por separado, y finalmente se toma un promedio de ambos mosaicos para generar una máscara de predicciones. El diagrama \todo[inline]{make diagram?} muestra el procedimiento de forma visual.
...
\begin{table}[ht!]
    ...
    \end{tabular}
    \caption{Hiperparámetros y resultados de la arquitectura U-Net. Entrenamiento en máquina 1.}
    \label{table:unet}
\end{table}
