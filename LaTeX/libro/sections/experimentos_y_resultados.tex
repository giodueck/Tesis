...
\todo{one with 1024 as bottleneck}

La pérdida de estos modelos es en general menor que la pérdida promedio de los modelos anteriores, y las máscaras generadas son mucho más detalladas.
