...
\todo[inline]{explicar mejor que es cada libreria (es python o que es)}
...
La implementación propia e integración de las herramientas mencionadas anteriormente se realizaron en una herramienta desarrollada para este trabajo, {\bf Torchbearer} \cite{torchbearer}. Esta permite la descripción de modelos y parámetros de entrenamiento de forma simple y paramétrica, diseñada para acelerar la iteración necesaria en la fase de experimentación y facilitar la creación de datos de inferencia (predicciones).
...
\todo[inline]{mostrar todos los datos de entrenamiento}
...
\begin{figure}[h!]
    \centering
    \subfloat[Mapa SWIR de referencia, tesela T20KNA]{\includegraphics[width=0.4\textwidth]{T20KNA_swir.jpg}}
    \qquad
...
\todo[inline]{poner un poco de python en apendice, algo en notebooks}
