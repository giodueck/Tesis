...
\begin{enumerate}
    \item Análisis de imágenes satelitales correspondientes a la región occidental del Paraguay a lo largo de un periodo temporal amplio \todo{confirmar con el profe} % multitemporales?
...
\todo{planteamiento/antecedentes}
