...
\begin{figure}
    \centering
    \subfloat[\centering Cámara digital normal]{\includegraphics[width=0.275\textwidth]{Death_Valley_from_space.JPG}}
    \qquad
    \subfloat[\centering Radar de Apertura Sintética]{\includegraphics[width=0.175\textwidth]{800px-Death-valley-sar.jpg}}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Electromagnetic_spectrum-es.svg.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{cnn-figure.png}
